(function() {
  ...
  schemaSubStructures = function(schema) {
    var item, name, properties, ref, ref1, structures, sub, subItem, subName;
    structures = {};
    ...
    if (properties != null) {
      for (name in properties) {
        ...
        if ((item.itemType != null) && ((ref1 = item.itemType) !== 'string' && ref1 !== 'number' && ref1 !== 'object' && ref1 !== 'enum' && ref1 !== 'boolean' && ref1 !== 'option')) {
