...
(function() {
  ...
  schemaSubStructures = function(schema) {
    var item, name, properties, ref, ref1, ref2, structures, sub, subItem, subName;
    structures = {};
    properties = {};
    ...
    } else if (((ref1 = schema.items) != null ? (ref2 = ref1.items) != null ? ref2.properties : void 0 : void 0) != null) {
  ...
  getTemplate = function(name, verbose, done) {
    var builtin, compileErr, compileOptions, compiled, compiledPath, dest, load, writeErr;
                  ...
                  results3.push((function() {
                    ...
                    for (q = 0, len8 = ref7.length; q < len8; q++) {
                      ...
                      results4.push((function() {
                        var len10, len11, len9, r, ref10, ref8, ref9, results5, t, u;
                        ref8 = example[name] || [];
                        results5 = [];
