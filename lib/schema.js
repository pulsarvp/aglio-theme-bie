(function() {
  var deepEqual, inherit, renderSchema, shouldAddStructure;

  deepEqual = require('assert').deepEqual;

  inherit = require('./inherit');

  shouldAddStructure = function(name, dataStructures, subStructure) {
    var i, item;
  ...
  module.exports = renderSchema = function(root, dataStructures) {
    var error, exclusive, i, item, items, j, k, key, len, len1, len2, len3, len4, m, member, n, name, o, option, optionSchema, prop, properties, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, required, schema, subStructures, typeAttr;
    schema = {};
    switch (root.element) {
      case 'boolean':
      case 'string':
    ...
    if (schema.properties) {
      ref15 = schema.properties;
      for (item = o = 0, len4 = ref15.length; o < len4; item = ++o) {
        i = ref15[item];
        if (shouldAddStructure(i, dataStructures, subStructures)) {
          subStructures = {
            type: item.type
          };
        }
