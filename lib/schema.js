(function() {
  ...
  module.exports = renderSchema = function(root, dataStructures) {
    var error, exclusive, i, item, items, j, k, key, len, len1, len2, len3, m, member, n, name, option, optionSchema, prop, properties, ref, ref1, ref10, ref11, ref12, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, required, schema, typeAttr;
    schema = {};
    switch (root.element) {
      case 'boolean':
      case 'string':
    ...
    if (((ref9 = root.attributes) != null ? ref9["default"] : void 0) != null) {
      schema["default"] = root.attributes["default"];
    }
    if (((ref10 = root.meta) != null ? ref10.id : void 0) != null) {
      schema.name = root.meta.id;
    }
    if (((ref11 = root.meta) != null ? ref11.description : void 0) != null) {
      schema.description = root.meta.description;
    }
    if ((ref12 = root.attributes) != null ? ref12.typeAttributes : void 0) {
